	...
	<div class="card">
		<div class="card-body">
			<?php if (empty($activities)) : ?>
				<div class="alert alert-warning" role="alert">Chưa có hoạt động!</div>
			<?php else : ?>
				<?php $i = 0; ?>
				<?php foreach ($activities as $activity) : ?>
					...
					<div class="row">
						<div class="col-sm-2">
							<a href="<?php prUrl('/hoat-dong/'.$activity['alias'].'-'.$activity['id'].'.html'); ?>" class="thumbnail">
						...
						<div class="col-sm-10">
							<a href="<?php prUrl('/hoat-dong/'.$activity['alias'].'-'.$activity['id'].'.html'); ?>"><strong><?php echo $activity['title']; ?></strong></a><br>
				...
				<nav aria-label="Page navigation">
				  	<ul class="pagination">
					    <li <?php echo ($currPage == 1 ? 'class="disabled"' : ''); ?>>
					      	<a href="<?php echo ($currPage == 1 ? '#' : base_url('/hoat-dong?page='.($currPage-1))); ?>" aria-label="Previous">
						    ...
						    <?php for ($i = 1; $i <= $numPage; $i++) : ?>
						    	<?php
						    		if ($i == $currPage) {
						    			...
						    			$active = '' ;
						    			$link = base_url('/hoat-dong?page='.$i);
						    		}
						    	?>
							...
							<?php for ($i = $currPage-2; $i <= $currPage+2; $i++) : ?>
						    	<?php
						    		...
						    		if ($i == $currPage) {
						    			...
						    			$active = '' ;
						    			$link = base_url($lang.'/hoat-dong?page='.$i);
						    		}
						    	?>
						    	<li <?php echo $active; ?>><a href="<?php echo $link; ?>"><?php echo $i; ?></a></li>
							<?php endfor; ?>
					    ...
					    <li <?php echo ($currPage == $numPage ? 'class="disabled"' : ''); ?>>
					      	<a href="<?php echo ($currPage == $numPage ? '#' : base_url('/hoat-dong?page='.($currPage+1))); ?>" aria-label="Next">
