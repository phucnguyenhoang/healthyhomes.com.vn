		...
		<div class="card-body">
			...
			<?php else : ?>
				...
				<?php foreach ($blogs as $blog) : ?>
					...
					<div class="row">
						<div class="col-sm-2">
							<a href="<?php prUrl('/blogs/'.$blog['alias'].'-'.$blog['id'].'.html'); ?>" class="thumbnail">
						...
						<div class="col-sm-10">
							<a href="<?php prUrl('/blogs/'.$blog['alias'].'-'.$blog['id'].'.html'); ?>"><strong><?php echo $blog['title']; ?></strong></a><br>
				...
				<nav aria-label="Page navigation">
				  	<ul class="pagination">
					    <li <?php echo ($currPage == 1 ? 'class="disabled"' : ''); ?>>
					      	<a href="<?php echo ($currPage == 1 ? '#' : base_url('/blogs?page='.($currPage-1))); ?>" aria-label="Previous">
							...
							<?php for ($i = $currPage-2; $i <= $currPage+2; $i++) : ?>
						    	<?php
						    		...
						    		if ($i == $currPage) {
						    			...
						    			$active = '' ;
						    			$link = base_url($lang.'/blogs?page='.$i);
						    		}
						    	?>
						    	<li <?php echo $active; ?>><a href="<?php echo $link; ?>"><?php echo $i; ?></a></li>
							<?php endfor; ?>
					    ...
					    <li <?php echo ($currPage == $numPage ? 'class="disabled"' : ''); ?>>
					      	<a href="<?php echo ($currPage == $numPage ? '#' : base_url('/blogs?page='.($currPage+1))); ?>" aria-label="Next">
